...
# Evaluate strategies
simple_results = evaluate_fitness(
    SimpleRSIStrategy, simple_rsi_grid, price_data, scoring_mode="confidence"
)
dual_results = evaluate_fitness(
    DualThresholdStrategy, dual_threshold_grid, price_data, scoring_mode="confidence"
)
